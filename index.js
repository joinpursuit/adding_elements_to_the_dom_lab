...
const numStat = () => {
    ...
    function userListRandom(array) {
        const list = document.createElement('li')
        list.innerText = `${array.name.first} ${array.name.last} (${array.nat})`;
        return list;
    }
    const users = objectUserList.results;
    const ulList = document.getElementById('user-list');
    users.forEach(array => {
        const callUserList = userListRandom(array);
