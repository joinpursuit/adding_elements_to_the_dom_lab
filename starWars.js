...
let info = planetInfo.results;
//   for(let planet in info ){
//       const li = document.createElement("li");
//       li.textContent = `${info[planet].name} (pop. ${info[planet].population})`
...
//   };
 ...
 info.forEach(data => {
 const li = document.createElement("li");
 li.textContent = `${data.name} (pop. ${data.population})`;
 document.querySelector("#planets-list").appendChild(li);
});
