const numStats = () => {
  let average = 
    document.getElementById("number-statistics-average");
  let maximum = 
    document.getElementById("number-statistics-maximum");
  let minimum = 
    document.getElementById("number-statistics-minimum");
  const input = 
    Number(document.getElementById("number-statistics-number-input").value);
